...
const Description = () => {
  return (
    ...
    >
      ...
      <p className='text-gray-500 mb-8'>Turn Words Into Stunning Images — Instantly</p>


      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center '>
        <img src={assets.sample_img_1} alt="" className='w-80 xl:w-96 rounded-lg' />
        <div>
          <h2 className='text-3xl font-medium max-w-lg mb-4'>AI-Powered Image Generation for Creators & Teams</h2>
