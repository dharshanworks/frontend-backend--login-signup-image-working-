...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >Unleash your creativty with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen.</motion.p>
            ...
            >
                ...
                {Array(6).fill('').map((item, index) => (
                    <motion.img className='rounded hover:scale-[1.05] transition-all duration-300 cursor-pointer max-sm:w-10'
